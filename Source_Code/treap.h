...
class Treap_node_t
{
    ...
    //function to split treap
    void union_split_node(Treap_node_t **left_sub_treap_root, Treap_node_t **right_sub_treap_root)
    {
        *left_sub_treap_root = this->left_n;
        *right_sub_treap_root = this->right_n;
        this->left_n = nullptr;
    ...
    Treap_node_t* union_node(Treap_node_t *left_treap, Treap_node_t *right_treap)
    {
        ...
        right_treap->union_split_node(&left_temp, &right_temp);
...
class Treap_t
{
    ...
    void union_split(key_t key, Treap_t *left_sub_treap, Treap_t *right_sub_treap)
    {
        this->root = this->root->insert_node(this->root, key, 101+rand()%100);
        this->root->union_split_node(&(left_sub_treap->root),&(right_sub_treap->root));
